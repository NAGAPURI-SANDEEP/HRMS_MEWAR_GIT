...
public class configcontractors  extends Base_Class {
	...
	public static void add_companies() throws InterruptedException {
        ...
        //Dates for holiday
        driver.findElement(By.xpath("//input[@id='contractorForm_firmName']")).sendKeys("Test.inc");
         
        driver.findElement(By.xpath("//input[@id='contractorForm_ownerName']")).sendKeys("TEST");
        
        driver.findElement(By.xpath("//input[@id='contractorForm_mobileNumber']")).sendKeys("9358880888");
        
        driver.findElement(By.xpath("//input[@id='contractorForm_panNo']")).sendKeys("AFZPK7091K");
        ...
        driver.findElement(By.xpath("//textarea[@id='contractorForm_address']")).sendKeys("Test");
