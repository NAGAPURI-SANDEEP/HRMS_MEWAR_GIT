...
public class Add_Employee extends Base_Class {
	...
	public void addemp() throws InterruptedException {
		...
		driver.findElement(By.xpath(
				...
				.click();
		driver.findElement(By.id("register_aadharNo")).sendKeys("123436558873");

		driver.findElement(By.id("register_firstName")).sendKeys("Naresh");
		...
		driver.findElement(By.id("register_emailId")).sendKeys("sandy@yopmail.com");
