...
public class ConfigurationShifts extends Base_Class {
	...
	public static void add_Shifts() throws InterruptedException {
        ...
        //Dates for holiday
        driver.findElement(By.xpath("//input[@id='register_name']")).sendKeys("Test");
         
        driver.findElement(By.xpath("//input[@id='register_shortCode']")).sendKeys("T1");
